...
public class PatientController {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_USER','ROLE_OFFICE_MANAGER')")
    public ResponseEntity<PatientWithAddressDto> getPatientById(@PathVariable Long id) {
    ...
    @PreAuthorize("hasAuthority('ROLE_OFFICE_MANAGER')")
    public ResponseEntity<PatientWithAddressDto> updatePatient(@PathVariable Long id, @RequestBody Patient patientDetails) {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_USER','ROLE_OFFICE_MANAGER')")
    public List<PatientWithAddressDto> searchPatients(@PathVariable String searchString) {
